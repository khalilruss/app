...
public class FragInLobbyRecyclerView extends RecyclerView.Adapter<FragInLobbyRecyclerView.myViewHolder> {

    Context context;
    List<Friend> mFriendList;
    private static BountyHunterAPI api;

    public FragInLobbyRecyclerView(Context context, List<Friend> mFriendList) {
