...
public class FragPendingRecyclerView  extends RecyclerView.Adapter<FragPendingRecyclerView.myViewHolder> {
    ...
    public FragPendingRecyclerView(Context context, List<Friend> mFriendList) {
