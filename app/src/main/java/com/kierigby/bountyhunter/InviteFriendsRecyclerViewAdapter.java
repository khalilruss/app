...
public class InviteFriendsRecyclerViewAdapter extends RecyclerView.Adapter<InviteFriendsRecyclerViewAdapter.MyViewHolder> {
    ...
    InviteFriendsRecyclerViewAdapter(List<Friend> users) {
        mFriendList = users;
    }
    ...
    @NonNull
    @Override
    public InviteFriendsRecyclerViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.creategame_item, viewGroup, false);
        return new InviteFriendsRecyclerViewAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final InviteFriendsRecyclerViewAdapter.MyViewHolder myViewHolder, final int i) {
