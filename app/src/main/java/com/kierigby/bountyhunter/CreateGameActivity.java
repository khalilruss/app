...
public class CreateGameActivity extends AppCompatActivity {
    ...
    private InviteFriendsRecyclerViewAdapter mInviteFriendRecyclerViewAdapter;
    ...
    private void setUpRecyclerView() {
        ...
        mInviteFriendRecyclerViewAdapter = new InviteFriendsRecyclerViewAdapter(friendsList);
